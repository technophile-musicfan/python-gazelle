...
Response models define how raw API JSON is deserialized into typed Python objects. All models use Pydantic v2. Shared base classes capture fields common to both Orpheus and Redacted; tracker-specific subclasses handle divergent schemas. Real API response fixtures from both trackers are captured and used as model test inputs to ensure correctness against live data.
