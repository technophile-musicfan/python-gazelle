...
Each resource class is exposed as a namespace on the client (e.g.
`client.torrents` → `TorrentResource`). Methods call the underlying Gazelle
`ajax.php` action and return typed [models](models.md).
